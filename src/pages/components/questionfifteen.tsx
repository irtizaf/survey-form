...
import { useFormData } from '../context/context'
  ...
  const Question15 = ({ data }: any) => {
      ...
      function handleSubmit(data: any) {
        ...
        setStyle(true)
        setStep(16)
        setFormData({...formData, queFifteen: data})
      }
                          ...
                          paddingY={{ sm: "15px", mm: "20px", md: "20px", lg: "45px", xl: "35px", "2xl": "54px" }}>
                          {
                              options.map((data: any) => {
                                  ...
                                  >
                                      ...
                                      width={{ sm: "18px", md: "18px", lg: "16px", xl: "22px", "2xl": "30px" }}
                                      paddingX={{ sm: "2px", md: "4px", lg: "6px", xl: "6px", "2xl": "6px" }} 
                                      paddingY={{ sm: "1px", md: "4px", lg: "5px", xl: "6px", "2xl": "6px" }} 
                                      fontSize={{ sm: "6px", md: "10px", lg: "14px", xl: "14px", "2xl": "22px" }} 
                                      // padding={"4px"}
                                      textColor={"white"}
                                      textAlign={"center"}
                                      >{data.opt_no}</Box>
